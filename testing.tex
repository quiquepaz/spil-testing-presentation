...
\logo{%
    ...
    \includegraphics[scale=0.20]{images/SPILhorizontal.eps}
    %\includegraphics[width=1cm,height=1cm,keepaspectratio]{images/}%
}
...
\begin{frame}{TDD refactor example}
    % TODO get_age/0 refactor example
\end{frame}
